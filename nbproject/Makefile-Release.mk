...
${OBJECTDIR}/HaarCascadeObjectDetector.o: HaarCascadeObjectDetector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HaarCascadeObjectDetector.o HaarCascadeObjectDetector.cpp

${OBJECTDIR}/NNController.o: NNController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NNController.o NNController.cpp

${OBJECTDIR}/NeuralNet.o: NeuralNet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NeuralNet.o NeuralNet.cpp
...
${OBJECTDIR}/NeuronLayer.o: NeuronLayer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NeuronLayer.o NeuronLayer.cpp

${OBJECTDIR}/eye_detect.o: eye_detect.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eye_detect.o eye_detect.cpp

${OBJECTDIR}/find_word.o: find_word.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/find_word.o find_word.cpp

${OBJECTDIR}/imageProcess.o: imageProcess.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/imageProcess.o imageProcess.cpp

${OBJECTDIR}/initializeNN.o: initializeNN.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initializeNN.o initializeNN.cpp
...
${OBJECTDIR}/poiDetection.o: poiDetection.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/poiDetection.o poiDetection.cpp

${OBJECTDIR}/tracking.o: tracking.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tracking.o tracking.cpp
