...
LDLIBSOPTIONS=-L/../../../../../opencv-2.4.3/release/lib ../../../../../MinGW/lib/libwinmm.a ../../../../../opencv-2.4.3/release/lib/libopencv_calib3d243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_contrib243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_core243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_features2d243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_flann243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_gpu243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_highgui243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_imgproc243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_legacy243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_ml243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_nonfree243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_objdetect243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_photo243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_stitching243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_ts243.a ../../../../../opencv-2.4.3/release/lib/libopencv_video243.dll.a ../../../../../opencv-2.4.3/release/lib/libopencv_videostab243.dll.a
...
${OBJECTDIR}/HaarCascadeObjectDetector.o: HaarCascadeObjectDetector.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/HaarCascadeObjectDetector.o HaarCascadeObjectDetector.cpp

${OBJECTDIR}/NNController.o: NNController.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NNController.o NNController.cpp

${OBJECTDIR}/NeuralNet.o: NeuralNet.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NeuralNet.o NeuralNet.cpp

${OBJECTDIR}/Neuron.o: Neuron.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Neuron.o Neuron.cpp

${OBJECTDIR}/NeuronLayer.o: NeuronLayer.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/NeuronLayer.o NeuronLayer.cpp

${OBJECTDIR}/eye_detect.o: eye_detect.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/eye_detect.o eye_detect.cpp

${OBJECTDIR}/find_word.o: find_word.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/find_word.o find_word.cpp

${OBJECTDIR}/imageProcess.o: imageProcess.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/imageProcess.o imageProcess.cpp

${OBJECTDIR}/initializeNN.o: initializeNN.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/initializeNN.o initializeNN.cpp

${OBJECTDIR}/main.o: main.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/main.o main.cpp

${OBJECTDIR}/poiDetection.o: poiDetection.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/poiDetection.o poiDetection.cpp

${OBJECTDIR}/tracking.o: tracking.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -I/../../../../../opencv-2.4.3/include -I/../../../../../MinGW/lib -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/tracking.o tracking.cpp
